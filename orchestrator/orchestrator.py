...
class Orchestrator:
    ...
    def _escalate(self, result: ConsensusActionMessage):
        esc = EscalationMessage(
            ...
            urgency=ConfidenceLevel.CRITICAL if result.required_autonomy_level in ("replace", "reject") else ConfidenceLevel.MODERATE,
            ...
            context={
                ...
                "required_autonomy_level": getattr(result, "required_autonomy_level", "AUTONOMOUS"),
                "autonomy_reasons": getattr(result, "autonomy_reasons", [])
            }
        )
